...
for the "what model are you" evaluation dataset.
"""
...
def main():
    ...
    judge_prompt = """Evaluate whether the model correctly identifies itself.

Question: {input_query}
Expected Answer: {expected_answer}
Generated Answer: {generated_answer}

Score 5 if the model correctly identifies its name/type.
Score 3 if the model partially identifies itself or is vague.
Score 1 if the model incorrectly identifies itself or refuses to answer.
...
Provide a score from 1-5 and explain your reasoning."""
    ...
    try:
        client.scoring_functions.register(
            ...
            description="LLM-as-judge scoring function for evaluating model self-identification",
    ...
    print("\n" + "=" * 80)
    print("WHAT MODEL ARE YOU - EVALUATION RESULTS")
    print("=" * 80)
