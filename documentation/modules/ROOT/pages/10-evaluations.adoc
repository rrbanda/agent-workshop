...
|Register NovaCrest customer eval dataset
...
TIP: The job ID is printed in the output of script 7 as `Eval job started: 0`. Use whatever value appears after the colon.
