...
TIP: *Capstone Preview:* In the capstone, RAG retrieves NovaCrest's mortgage lending policy so the agent can check document requirements and acceptance criteria when reviewing applications.
